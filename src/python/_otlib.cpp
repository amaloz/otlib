...
methods[] = {
    ...
    {"ot_np_send", py_ot_np_send, METH_VARARGS, "sender operation for Naor-Pinkas OT."},
    {"ot_np_receive", py_ot_np_recv, METH_VARARGS, "receiver operation for Naor-Pinkas OT."},
